...
import Transactions from './components/Transcitions'
  ...
  const renderSuccessView = () => {
    ...
    return (
      <div>
        ...
        <Barchart barChartData={apiData.barChart} month={currentMonth} />
        <Piechart pieChartData={apiData.pieChart} month={currentMonth} />
      </div>
    )
  }
